...
export function UploadBillCard() {
  ...
  const isSubmitting = uploadBill.isPending
  ...
  async function handleContinue() {
    ...
    try {
      const bill = await uploadBill.mutateAsync({ file })
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <p className="mt-1 text-sm text-slate-500">
        Snap or upload a receipt and we'll read the items for you. Confirming it opens its tab.
      </p>
