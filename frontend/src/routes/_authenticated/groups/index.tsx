      ...
      {isCreating && (
        <div className="mt-4 flex gap-2 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
          <input
            ...
            className="flex-1 rounded-lg border border-slate-300 px-3 py-2 text-sm outline-none placeholder:text-slate-400 focus:border-violet-500 focus:ring-2 focus:ring-violet-500/50"
          />
          <button
            type="button"
